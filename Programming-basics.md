...
```
Where `for (int n=0; n<9; n++)` is a loop definition: start from 0 (n=0), untill we reach 9 (n<9), with a step of 1 (n++) execute everything located in `{}` — print "Hello, World!"
