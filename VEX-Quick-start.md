...
Next, we need to set a proper position for each point inside our loop to form a line. Our first point may stay at the origin (0,0,0) but each next point should have X coordinate increasing by some value (<increasingValue>, 0, 0).
